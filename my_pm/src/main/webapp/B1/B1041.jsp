		...
		<div class="edit">
			<table>
				...
				<tr>
					...
					<td>录入时间</td>
					<td><e:date name="mbegintime" defval="${ins.begintime }" /></td>
				</tr>
				<tr>
					<td>预约号</td>
				...
				<tr class="edit_button">
					<td colspan="4"><input type="submit" name="next" value="删除"
						formaction="<%=path%>/B1042.htm"> <input type="submit"
						name="next" value="返回" formaction="<%=path%>/B1040.htm"></td>
				</tr>
			</table>
		</div>
