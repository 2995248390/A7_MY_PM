...
@WebServlet("/a1053.htm")
public class A1053Servlet extends BaseServlet
{
	...
	protected String execute(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		int result=services.batchHide();
		String msg=null;
		if(result!=3)
			msg=result==1?"该评论已隐藏":"无权限进行此操作";
		else
			msg="请选择操作对象";
		//按照原查询条件显示结果
